...
const ProjectCard: React.FC<ProjectCardProps & { forcedRisk?: 'high' | 'medium' | 'low' }> = ({ name, risk, defectCounts, onClick, size = 'large', forcedRisk, customBgClass, riskTextClass, riskLabel }) => {
